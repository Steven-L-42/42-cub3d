...
SRCS				=	main.c init_1.c init_2.c utils_main.c utils_free.c parse_map.c utils_map.c utils_basic.c utils_color.c utils_image.c calc_distance.c calc_distance2.c movement.c wall_detection.c minimap.c rays.c calc_view.c
